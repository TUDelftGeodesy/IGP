...
stmplotmapbyepoch('../0_import_06gps/06gps_nam_202107.mat','saveplt','./plt_imports/')
% Plot the timeseries
stmplotseries('../0_import_06gps/06gps_nam_202107.mat','schranking','none','saveplt','./plt_imports/');

% results from the decomposition
stmplotseries('../1_decompose_06gps/06gps_nam_202107_decomposed.mat','schranking','none','saveplt','./plt_imports/');
stmplotseries('../1_decompose_06gps/06gps_nam_202107_decomposed.mat','schranking','none','item','auxData','saveplt','./plt_imports/')


%% GPS Campaign data

% Plot network map by epoch -> plots are saved to a pdf 
stmplotmapbyepoch('../0_import_campaigns/lts2_allgps_v6.0_20220111.mat','saveplt','./plt_imports/');
% Estimate velocities and plot (using default 'refsystem'='min-velocities')
stmplotvel('../0_import_campaigns/lts2_allgps_v6.0_20220111.mat','saveplt','./plt_imports/');
% Plot the timeseries
stmplotseries('../0_import_campaigns/lts2_allgps_v6.0_20220111.mat','schranking','none','marker',true,'saveplt','./plt_imports/');
stmplotseries('../0_import_campaigns/lts2_allgps_v6.0_20220111.mat','schranking','ssdnorm','marker',true);

%% Levelling data (full period)

% Plot network map by epoch
stmplotmapbyepoch('../0_import_campaigns/lts2_levelling_v6_all.mat','maxepochs',60,'saveplt','./plt_imports/');
stmplotmapbyepoch('../0_import_campaigns/lts2_levelling_ameland_full_period.mat','saveplt','./plt_imports/');
stmplotmapbyepoch('../0_import_campaigns/lts2_levelling_vasteland_full_period.mat','saveplt','./plt_imports/');

% Estimate velocities and plot (using default 'refsystem'='min-velocities')
stmplotvel('../0_import_campaigns/lts2_levelling_ameland_full_period.mat','saveplt','./plt_imports/');
stmplotvel('../0_import_campaigns/lts2_levelling_vasteland_full_period.mat','saveplt','./plt_imports/');

% Plot the timeseries
stmplotseries('../0_import_campaigns/lts2_levelling_ameland_full_period.mat','schranking','ssdnorm','marker',true,'saveplt','./plt_imports/');
stmplotseries('../0_import_campaigns/lts2_levelling_vasteland_full_period.mat','schranking','ssdnorm','marker',true,'maxPlots',4,'saveplt','./plt_imports/');
...
stmplotvel(stmreduced,'saveplt','./plt_reduced/','append',true)
