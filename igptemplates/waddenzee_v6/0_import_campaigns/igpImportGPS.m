...
%   stmplotmapbyepoch('../0_import_campaigns/lts2_allgps_v6.0_20220111.mat','saveplt','./');
%
%   % Estimate velocities and plot (using default 'refsystem'='min-velocities'
%   stmplotvel('../0_import_campaigns/lts2_allgps_v6.0_20220111.mat','saveplt','./');
%
%   % Plot the timeseries
%   stmplotseries('../0_import_campaigns/lts2_allgps_v6.0_20220111.mat','schranking','none','marker',true,'saveplt','./');
