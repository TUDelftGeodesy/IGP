...
outputFilename = './waddenzee_2015_predicted.mat';
stmpredict(inputFilename,outputFilename,options,'overwrite');

outputFilename = './waddenzee_2015_predicted_list_wgs84.mat';
options.crsOutput = 'wgs84';
options.spaceOutput = { 'list' 'pointlist_wgs84_waddenzee_2015.txt' 'deg' };
options.timeOutput = { 'list' 'epochlist1_waddenzee_2015.txt' 'year' };
stmpredict(inputFilename,outputFilename,options,'overwrite');

outputFilename = './waddenzee_2015_predicted_list_rd.mat';
options.crsOutput = 'RD';
options.spaceOutput = { 'list' 'pointlist_rd_waddenzee_2015.txt' 'm' };
options.timeOutput = { 'list' 'epochlist2_waddenzee_2015.txt' 'year'};
stmpredict(inputFilename,outputFilename,options,'overwrite');

outputFilename = './waddenzee_2015_predicted_list_rd_roi.mat';
options.ROI = [230000 570000; 250000 590000];
options.crsROI = 'EPSG28992';
%options.crstoolbox = 'proj4';
stmpredict(inputFilename,outputFilename,options,'overwrite');
