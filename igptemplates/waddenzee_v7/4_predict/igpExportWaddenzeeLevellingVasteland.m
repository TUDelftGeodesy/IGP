...
%% Perform export
inputFilename = './lts2_levelling_vasteland_full_period_predicted.mat';
stmexport(inputFilename,options);

options.background = '../9_output/igp-background.mat';
inputFilename = './lts2_levelling_vasteland_full_period_predicted_list_wgs84.mat';
stmexport(inputFilename,options);

options.background = '../9_output/igp-background-rd.mat';
inputFilename = './lts2_levelling_vasteland_full_period_predicted_list_rd.mat';
stmexport(inputFilename,options);

inputFilename = './lts2_levelling_vasteland_full_period_predicted_list_rd_roi.mat';
stmexport(inputFilename,options);
