...
inputFilename = '../0_import_campaigns/lts2_levelling_vasteland_v7_full_period.mat';
...
fid = fopen('pointlist_wgs84_levelling_vasteland.txt','w');
...
fid2 = fopen('pointlist_rd_levelling_vasteland.txt','w');
...
fid3 = fopen('epochlist1_levelling_vasteland.txt','w');
fprintf(fid3,['%6.2f\n'],epochs1);
fclose(fid3);

fid4 = fopen('epochlist2_levelling_vasteland.txt','w');
fprintf(fid4,['%6.2f\n'],epochs2);
fclose(fid4);
