...
switch item
  case {'Velocity','velocity'}
    ...
    for i=1:nstations
      ...
      vel=tseries.vel;
      pltarrow(rdnap(i,1:2)/1000,rdnap(i,1:2)/1000+[vel(2) vel(1)]*1000*5/vscale(1),'r','LineWidth',2);
      pltarrow(rdnap(i,1:2)/1000,rdnap(i,1:2)/1000+[0 vel(3)]*1000*5/vscale(2),'k','LineWidth',2);
    end
    pltarrow(xylegend,xylegend+[.005 0]*1000,'r','LineWidth',2);
    pltarrow(xylegend,xylegend+[0 .005]*1000,'k','LineWidth',2);
    text(xylegend(1)+5,xylegend(2)+1,[ ' ' num2str(vscale(1)) ' mm/y Horz'],'FontWeight','bold');
    text(xylegend(1),xylegend(2)+6,[' ' num2str(vscale(2)) ' mm/y Up'],'FontWeight','bold');
  case {'Tempi','tempi'}
