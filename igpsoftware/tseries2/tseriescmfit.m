...
for i=1:nstations
   ...
   if init
      ...
      if i3-i1 > size(xlat,1), error('series are allowed to have more parameters than the first series'); end
   end
   ...
   wlati=inv(qxlati);
   xlat(1:i3-i1)=xlat(1:i3-i1)+wlati*xlati;
   qxlat(1:i3-i1,1:i3-i1)=qxlat(1:i3-i1,1:i3-i1)+wlati;
   wloni=inv(qxloni);
   xlon(1:i3-i1)=xlon(1:i3-i1)+wloni*xloni;
   qxlon(1:i3-i1,1:i3-i1)=qxlon(1:i3-i1,1:i3-i1)+wloni;
   wradi=inv(qxradi);
   xrad(1:i3-i1)=xrad(1:i3-i1)+wradi*xradi;
   qxrad(1:i3-i1,1:i3-i1)=qxrad(1:i3-i1,1:i3-i1)+wradi;
   xlatstations(1:i3-i1,i)=xlati;
   xlonstations(1:i3-i1,i)=xloni;
   xradstations(1:i3-i1,i)=xradi;
end
qxlat=inv(qxlat);
xlat=qxlat*xlat;
qxlon=inv(qxlon);
